module verifier_addr::stark_verifier_7 {
    ...
    use verifier_addr::stark_parameters_7::{LOG_CPU_COMPONENT_HEIGHT, LAYOUT_CODE, N_OODS_VALUES, PUBLIC_MEMORY_STEP,
        N_COLUMNS_IN_MASK, N_COLUMNS_IN_TRACE0, N_COLUMNS_IN_TRACE1, CONSTRAINTS_DEGREE_BOUND, N_INTERACTION_ELEMENTS,
        N_COEFFICIENTS, N_OODS_COEFFICIENTS
    };
    use verifier_addr::cpu_public_input_offset_base::{OFFSET_LOG_N_STEPS, OFFSET_RC_MIN, OFFSET_RC_MAX,
        OFFSET_LAYOUT_CODE, OFFSET_PROGRAM_BEGIN_ADDR, OFFSET_PROGRAM_STOP_PTR, INITIAL_PC, FINAL_PC,
        OFFSET_EXECUTION_BEGIN_ADDR, OFFSET_EXECUTION_STOP_PTR
    };
    use verifier_addr::cpu_public_input_offsets_7::{OFFSET_PUBLIC_MEMORY, OFFSET_N_PUBLIC_MEMORY_PAGES,
        OFFSET_PUBLIC_MEMORY_PADDING_ADDR
    };
    ...
    use verifier_addr::memory_map_7::{MM_FRI_LAST_LAYER_DEG_BOUND, MM_TRACE_LENGTH, MM_PROOF_OF_WORK_BITS,
        ...
        MM_INTERACTION_ELEMENTS, MM_MEMORY__MULTI_COLUMN_PERM__PERM__INTERACTION_ELM,
        MM_MEMORY__MULTI_COLUMN_PERM__HASH_INTERACTION_ELM0, MM_RANGE_CHECK16__PERM__INTERACTION_ELM,
        MM_MEMORY__MULTI_COLUMN_PERM__PERM__PUBLIC_MEMORY_PROD,
        MM_OODS_ALPHA, MM_FRI_COMMITMENTS, MM_FRI_EVAL_POINTS,
        MM_FRI_QUEUE, MM_OODS_EVAL_POINTS, MM_MERKLE_QUEUE, MM_TRACE_QUERY_RESPONSES, MM_COMPOSITION_QUERY_RESPONSES,
